      ...
      <Card className='w-full max-w-md mx-auto'>
        <CardHeader>
          <CardTitle className='text-2xl font-bold'>
            {provider.name} Offramp Request
          </CardTitle>
          <CardDescription>
            Review your transaction details and execute the offramp request
          </CardDescription>
        </CardHeader>
        <CardContent className='p-6'>
          ...
          <div className='mt-4 space-y-2'>
            <p>
              <strong>Chain:</strong> {transactionDetails.chain}
            </p>
            <p>
