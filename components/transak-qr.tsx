...
export function TransakQR({ transactionDetails, onComplete }: QRDisplayProps) {
...
<RefreshCw className="h-8 w-8 animate-spin text-primary" />
            ...
            <Button variant="outline" onClick={handleCopy}>
              ...
              {copied ? "Copied!" : "Copy Transak Data"}
            </Button>
          </div>
        </CardContent>
      </Card>
          ...
          >
            {status === "success" ? (
              <>
                ...
                <h3 className="text-lg font-medium text-green-600">Transak Transaction Complete!</h3>
              ...
              <>
                ...
                <h3 className="text-lg font-medium text-red-600">Transak Transaction Failed</h3>
