...
export function UnlimitQR({ transactionDetails, onComplete }: QRDisplayProps) {
        ...
        <CardContent className="p-6">
          <div className="flex flex-col items-center space-y-4">
            ...
            <Button variant="outline" onClick={handleCopy}>
              ...
              {copied ? "Copied!" : "Copy Unlimit Data"}
            </Button>
          </div>
        </CardContent>
      </Card>
          ...
          >
            {status === "success" ? (
              <>
                ...
                <h3 className="text-lg font-medium text-green-600">Unlimit Transaction Complete!</h3>
              ...
              <>
                ...
                <h3 className="text-lg font-medium text-red-600">Unlimit Transaction Failed</h3>
